...
/*
 JdbcTemplate관련 주요 메서드
 
 Object queryForObject(String sql, RowMapper rm)
 	:하나의 레코드나 결과값을 반환하는 select계열의 쿼리문을 실행할 때 사용함
 Object queryForObject(string sql, Object[] args, RowMapper rm)
 	:인파라미터가 있고, 하나의 레코드를 반환하는 select계열의 쿼리문 실행에 사용함
 ...
 int update(String sql)
 	:인파라미터가 없는 update/insert/delete쿼리문을 처리할 때 사용한다.
 int update(String sql, Object[] args)
 	:인파라미터가 있는 update/insert/delete쿼리문을 처리할 때 사용한다.
 *
 *
 */
...
public class JDBCTemplateDAO {
	...
	public ArrayList<SpringBbsDTO> list(
		...
		List 컬렉션에 적재하여 반환한다. 그러므로 DAO에서 개발자가 
		반복적으로 하던 작업을 자동으로 처리해준당
		 */
	...
	public void write(final SpringBbsDTO springBbsDTO) {
		...
		/*
		 ...
		 final로 선언하지 않으면 에러가 발생함. 이것은 Java의 규칙임
		 */
